...
if __name__== "__main__":
  ...
  # 1. set the heat to output.heat(1)
  # 2. screw the horn to the servo
  # 3. run this and test for binding from 100 down to zero heat
  # 100 heat is completely closed
  # 0 heat is completely open
